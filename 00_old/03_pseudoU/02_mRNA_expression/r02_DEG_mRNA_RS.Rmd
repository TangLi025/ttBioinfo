...
# ~/Data/09_PseudoU/04_aging_mRNA/04_RS_DEG/

work_dir <- "~/Data/09_PseudoU/04_aging_mRNA/04_RS_DEG/"
require("knitr")
...
sample_name <- c(paste(rep(c("P12","P16","P13_shCtrl","P13_shDKC1"),each=2),rep(c("1","2"),times=4),sep = "_"))
express_matrix <- fc_result_count[,13:20]
colnames(express_matrix) <- sample_name

# batch <- c(rep("p6",4),rep("p8",4))
...
meta_data <- data.frame(rep = rep(c("rep1","rep2"),times=4),
                        stage = rep(c("P12","P16","P13_shCtrl","P13_shDKC1"),each=2),

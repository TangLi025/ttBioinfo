...
require("knitr")
opts_knit$set(root.dir = "~/Data/01_TC1/26_LACE_seq_Nudt21/04_hisat2_mapping/dedup_vs_vs/06_macs2_peak/05_ext50_mm/")
```

```{r peakAnno replication}

common_peak_dir <- "/disk/user_09/Data/01_TC1/26_LACE_seq_Nudt21/04_hisat2_mapping/dedup_vs_vs/06_macs2_peak/05_ext50_mm/"
...
P0_export <- transform(P0_export,peakNames=paste0("peak",rownames(P0_export)))
...
P9_export <- transform(P9_export,peakNames=paste0("peak",rownames(P9_export)))

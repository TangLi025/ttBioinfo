---
title: "01_mRNA_expression_dulab"
author: "Tang Li"
date: '2023-02-12'
...
# ~/Data/01_TC1/01_mRNA_expression/12_dulab_TBLC_PSC_TSC_XEN

require("knitr")
opts_knit$set(root.dir = file.path("~/Data/01_TC1/01_mRNA_expression/12_dulab_TBLC_PSC_TSC_XEN/"))
```

```{r generate bam list}

dir1='~/Data/03_du_TC/03_dulab_TBLC_PSC_XEN_TSC/03_hisat2_mapping/03_bam_merge'
sample_name1 <- c("TBLC_P14","TBLC_P19","PSC",
                  "TSC_sort_P0","TSC_sort_P1","TSC_sort_P2",
                  "XEN_Sort_P0","XEN_Sort_P1","XEN_Sort_P2")
...
meta_data <- data.frame(rep = rep("rep1",9),
                        stage = sample_name,
...
for (i in group){
  temp <- t(scale(t(tpm_matrix[rownames(tpm_matrix) %in% get(paste0("marker_",i)),c(7:10)])))
  temp <- na.omit(temp)

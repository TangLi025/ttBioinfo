...
require(knitr)
opts_knit$set(root.dir = "~/Data/02_embryo/01_mouse_embryo_scRNA-seq_2014_Ding/")

```

```{r}
file_list <- list.files("01_expression/")[c(277:280,114:121,205:216,165:174,51:64,65:92,1:50,122:164,217:276,175:204)]

temp <- read.table("01_expression/GSM1112490_16cell_1-10_expression.txt",header = F)

...
# ~/Data/01_TC1/01_mRNA_expression/13_siNudt21_merge

require("knitr")
opts_knit$set(root.dir = file.path("~/Data/01_TC1/01_mRNA_expression/13_siNudt21_merge/"))
...
pdf("03_PCA/02_allmarker_rlog.pdf",width = 10,height = 7)
print(p1)
dev.off()
...
pdf("03_PCA/02_allmarker_vst.pdf",width = 10,height = 7)
print(p1)
dev.off()
```

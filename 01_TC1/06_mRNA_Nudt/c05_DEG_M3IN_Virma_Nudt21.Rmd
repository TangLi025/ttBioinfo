...
# /disk/user_09/Data/01_TC1/24_mito_ribo_Nudt21/03_hisat2_mapping/04_DEG/04_DEG.Rproj

require("knitr")
opts_knit$set(root.dir = file.path("/disk/user_09/Data/01_TC1/24_mito_ribo_Nudt21/03_hisat2_mapping/04_DEG"))
...
cd /disk/user_09/Data/01_TC1/24_mito_ribo_Nudt21/03_hisat2_mapping/04_DEG
...
fc_exon_count <- fc_exon[,9:55]
colnames(fc_exon_count) <- c(sample_name1,sample_name2,sample_name3,sample_name4)
...
```{r betweenLaneNormalization no XEN}
set_matrix_DEG <- fc_exon_count_pc

sample_name <- colnames(set_matrix_DEG)
meta_data <- data.frame(rep = c(rep(c("rep1","rep2"),times=8),rep("rep1",23),rep(c("rep1","rep2"),times=4)),
                        stage = c(rep(c("p6_siNC","p6_siNudt21_1","p6_siNudt21_3",
                                        "Ctrl","M3IN","siNC","siM3","siVirma"),each=2),
                                  "P8_Ctrl_Ctrl","P8_M3IN_Ctrl",
                                  "P8_M3IN_At-c1","P8_M3IN_At-c2","P8_M3IN_CCCP-c1","P8_M3IN_CCCP-c2","P8_M3IN_CX-c1","P8_M3IN_CX-c2","P8_M3IN_Rbin-c1","P8_M3IN_Rbin-c2",
                                  "P14_siNC-1","P14_siNudt21","P14_siM3","P14_siNC-2","P14_siVirma",
                                  "P0_siNudt21_Ctrl","P0_siNudt21_dox","P2_siNudt21_Ctrl","P2_siNudt21_dox","P4_siNudt21_Ctrl","P4_siNudt21_dox","P5_siNudt21_Ctrl","P5_siNudt21_dox",
                                  rep(c("p0_total","p5_total","p10_total","rp2_total"),each=2)),
...
## 批次校正
batch <- c(rep("p6si",6),rep("p16si",10),rep("p8in",10),rep("p14si1",3),rep("p14si2",2),rep("siNudtdox",8),rep("mRNA",8))
# # 
...
## DESeq2
```{r create dds object and plot pca clear}
...
clear <- c(3,4,7:10,15,16,27:31,40:47)

dds <- DESeqDataSetFromMatrix(countData = express_matrix[,clear],colData = meta_data[clear,],design = ~ stage)
...
pdf("01_pca/01_pca_rlog_clear2.pdf",width = 15,height = 7)
print(p1)
dev.off()
...
pdf("01_pca/01_pca_vst_clear2.pdf",width = 15,height = 7)
print(p1)
dev.off()
```
...
pdf("01_pca/01_pca_vst.pdf",width = 30,height = 10)
print(p1)
dev.off()
```

...
M3IN_0h_anno <- read.delim('../03_bed_merge/05_annotation/M3IN_0h_annotation.txt',header = T)
M3IN_4h_anno <- read.delim('../03_bed_merge/05_annotation/M3IN_4h_annotation.txt',header = T)
M3IN_12h_anno <- read.delim('../03_bed_merge/05_annotation/M3IN_12h_annotation.txt',header = T)
...
pdf("./03_annotation/02_Distribution_of_m6A_peaks.pdf")
# draw pie

...
#dir.create("07_site_filter_group/01_sen/input5_count3_ratio5_fraction10")
...
pdf("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/02_venn.pdf")
plot(venn_P12) 
plot(venn_P16) 
plot(venn_sen)
dev.off()

pdf("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/03_col_heatmap.pdf")
quickcor(site_info_anno[P12_conf_name,
...
quickcor(site_info_anno[P16_conf_name,
...
pdf("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/04_point_line_rep3.pdf",width = 5)
  ...
  p <- ggplot(site_info_anno[venn_P12@IntersectionSets$`111`,],aes(x=P12_BS_1_del_fraction,y=P12_BS_3_del_fraction))+
    geom_point(col="#ff624b")+
    geom_abline(slope=1,intercept = 0)+
    xlim(0,1)+
    ylim(0,1)+
  ...
  p <- ggplot(site_info_anno[venn_P12@IntersectionSets$`111`,],aes(x=P12_BS_2_del_fraction,y=P12_BS_3_del_fraction))+
    geom_point(col="#ff624b")+
    geom_abline(slope=1,intercept = 0)+
    xlim(0,1)+
    ylim(0,1)+
  ...
  p <- ggplot(site_info_anno[venn_P16@IntersectionSets$`111`,],aes(x=P16_BS_1_del_fraction,y=P16_BS_2_del_fraction))+
    geom_point(col="#ff624b")+
    geom_abline(slope=1,intercept = 0)+
    xlim(0,1)+
    ylim(0,1)+
  ...
  p <- ggplot(site_info_anno[venn_P16@IntersectionSets$`111`,],aes(x=P16_BS_1_del_fraction,y=P16_BS_3_del_fraction))+
    geom_point(col="#ff624b")+
    geom_abline(slope=1,intercept = 0)+
    xlim(0,1)+
    ylim(0,1)+
  ...
  p <- ggplot(site_info_anno[venn_P16@IntersectionSets$`111`,],aes(x=P16_BS_2_del_fraction,y=P16_BS_3_del_fraction))+
    geom_point(col="#ff624b")+
    geom_abline(slope=1,intercept = 0)+
    xlim(0,1)+
    ylim(0,1)+
...
pdf("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/05_pU_level_region.pdf",width = 6)
...
ggplot(temp,aes(x = '',y = Freq,fill = Var1)) +
  ...
  coord_polar(theta = 'y') +
  scale_fill_brewer(palette = 'Set2',name = paste0('Total=',dim(sen_site)[1]))
...
write.table(sen_site,"07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/sen_site.txt",quote = F,row.names = T,col.names = T,sep = '\t')
...
P12_frac_mean <- mean(sen_site_melt[sen_site_melt$group=="P12","mean_fraction"])
P16_frac_mean <- mean(sen_site_melt[sen_site_melt$group=="P16","mean_fraction"])

pdf("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/06_mean_fraction_beeswarm.pdf")
ggplot(sen_site_melt, aes(x = mean_fraction, y = group,col=group,fill=group,shape=group)) +
  geom_quasirandom(alpha=0.7,size=2,groupOnX=FALSE,varwidth=T,show.legend = F) +
  ...
  annotate("text", x = 0.2, y = 2.5, label=sprintf("%0.1f%%",10),size = 6)+
  annotate("text", x = 0.6, y = 2.5, label=sprintf("%0.1f%%",50),size = 6)+
  annotate("segment", x = P12_frac_mean, xend = P12_frac_mean, y = 0.7, yend = 1.3,size = 2,col="#ff624b")+
  annotate("segment", x = P16_frac_mean, xend = P16_frac_mean, y = 1.7, yend = 2.3,size = 2,col="#ff624b")+
  annotate("text", x = P12_frac_mean, y = 0.6, label=sprintf("%0.1f%%",P12_frac_mean*100),size = 6,col="#ff624b")+
  annotate("text", x = P16_frac_mean, y = 2.4, label=sprintf("%0.1f%%",P16_frac_mean*100),size = 6,col="#ff624b")+
  theme_bar+
  theme(plot.margin = margin(t=2,r=0.5,b=2,l=0.5,unit = "cm"))+
...
pdf("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/07_mean_fraction_barplot.pdf")
...
P16_other_site <- sen_site[!sen_site$diff_frac_group=="P16_high",]
frequent_motif_P16_other <- aggregate(P16_other_site[,c(72,73)],by=list(c(P16_other_site$motif)),FUN="mean")
colnames(frequent_motif_P16_other) <- c("motif","fraction_P12","fraction_P16")

motif_count <- as.data.frame(table(c(P16_other_site$motif)))
colnames(motif_count) <- c("motif","freq")

frequent_motif_P16_other <- merge(motif_count,frequent_motif_P16_other)
frequent_motif_P16_other$freq_percent <- frequent_motif_P16_other$freq/(dim(P16_other_site)[1])
...
sen_site$pos <- as.numeric(sen_site$pos)
...
dir <- "07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/"
...
guitar_plot <- GuitarPlot(txTxdb = txdb,
           ...
           pltTxType = c("mrna"),
           stGroupName = c("sen","P16_high","P16_other"),
           txMrnaComponentProp = c(0,1/3,1/3,1/3,0))
# draw
pdf("~/Data/09_PseudoU/06_aging_pU_SE/04_hisat2_mapping/08_site_filter3/07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/09_metagene_profiles_of_pU_site.pdf")
...
guitar_plot <- GuitarPlot(txTxdb = txdb,
           ...
           #txMrnaComponentProp = c(0,1/3,1/3,1/3,0))
# draw
pdf("~/Data/09_PseudoU/06_aging_pU_SE/04_hisat2_mapping/08_site_filter3/07_site_filter_group/01_sen/input5_count3_ratio5_fraction10/09_metagene_profiles_of_pU_site_gencode.pdf")
print(guitar_plot+theme_bar)
dev.off()
...
dir.create("07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/02_site_pc_bed")
sen_site_pc$pos <- as.numeric(sen_site_pc$pos)

sen_site_pc_bed <- data.frame(chr=sen_site_pc$chr,
                              start=sen_site_pc$pos,
                              end=sen_site_pc$pos+1,
                              name=paste0(sen_site_pc$chr,"_",sen_site_pc$pos),
                              score=".",
                              strand=sen_site_pc$strand)
is.na(sen_site_pc_bed)
write.table(sen_site_pc_bed,"07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/02_site_pc_bed/sen_site_pc.bed",quote = F,row.names = F,col.names = F,sep = '\t')

sen_P16h <- sen_site_pc[sen_site_pc$diff_frac_group=="P16_high",]
sen_P16h_bed <- data.frame(chr=sen_P16h$chr,
                              start=sen_P16h$pos,
                              end=sen_P16h$pos+1,
                              name=paste0(sen_P16h$chr,"_",sen_P16h$pos),
                              score=".",
                              strand=sen_P16h$strand)
write.table(sen_P16h_bed,"07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/02_site_pc_bed/sen_P16h.bed",quote = F,row.names = F,col.names = F,sep = '\t')

sen_P16other <- sen_site_pc[!sen_site_pc$diff_frac_group=="P16_high",]
sen_P16other_bed <- data.frame(chr=sen_P16other$chr,
                              start=sen_P16other$pos,
                              end=sen_P16other$pos+1,
                              name=paste0(sen_P16other$chr,"_",sen_P16other$pos),
                              score=".",
                              strand=sen_P16other$strand)
write.table(sen_P16other_bed,"07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/02_site_pc_bed/sen_P16other.bed",quote = F,row.names = F,col.names = F,sep = '\t')



# read bed file
stBedFiles <- list("sen_site_pc.bed","sen_P16h.bed","sen_P16other.bed")
...
guitar_plot <- GuitarPlot(txTxdb = txdb,
           stBedFiles = file.path(dir,"02_site_pc_bed",stBedFiles),
           headOrtail = FALSE,
           enableCI = FALSE,
           mapFilterTranscript = TRUE,
           pltTxType = c("mrna"),
           ...
           txMrnaComponentProp = c(0,1/3,1/3,1/3,0))
# draw
pdf("~/Data/09_PseudoU/06_aging_pU_SE/04_hisat2_mapping/08_site_filter3/07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/09_metagene_profiles_of_pU_site_pc.pdf")
print(guitar_plot+theme_bar)
dev.off()
...
guitar_plot <- GuitarPlot(txTxdb = txdb,
           ...
           #txMrnaComponentProp = c(0,1/3,1/3,1/3,0))
# draw
pdf("~/Data/09_PseudoU/06_aging_pU_SE/04_hisat2_mapping/08_site_filter3/07_site_filter_group/01_sen/input5_count5_ratio3_fraction5/09_metagene_profiles_of_pU_site_pc_gencode.pdf")
print(guitar_plot+theme_bar)
dev.off()
```
